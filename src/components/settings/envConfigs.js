...
export default function EnvConfigs() {
  ...
  const [minBreadth, setMinBreadth] = useState(false);
  const [minHeight, setMinHeight] = useState(false);
  const [maxLength, setMaxLength] = useState(false);
  const [maxBreadth, setMaxBreadth] = useState(false);
  const [maxHeight, setMaxHeight] = useState(false);
  const [minParcelWeight, setMinParcelWeight] = useState(false);
  const [maxParcelWeight, setMaxParcelWeight] = useState(false);
